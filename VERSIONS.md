...
| **Azure Provider** | ~> 4.65.0 | `Check latest` | ⚠️ **Check latest** (v4 upgrade; run Cloud Shell plan/apply) | `terraform/main.tf` | [Azure Provider Releases](https://github.com/hashicorp/terraform-provider-azurerm/releases) |
