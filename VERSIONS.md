...
| **kubectl (Pod Cleanup)** | `v1.34.3` | `v1.34.x` | ✅ **Matches AKS cluster** (2026-07-20) | `ops/manifests/maintenance-stale-pod-cleanup.yaml` | [Kubernetes kubectl](https://kubernetes.io/docs/reference/kubectl/) |
...
| Component | Current Version | Latest Version | Upgrade Status | Location | Update Source |
|-----------|----------------|----------------|----------------|----------|---------------|
| **Jenkins Helm Chart** | `5.8.110` | `5.8.110` | Historical AKS controller config; current controller lives on OKE | `jenkins-values.yaml` | [Jenkins Helm Charts](https://github.com/jenkinsci/helm-charts/releases) |
...
| **Azure Provider** | `~> 4.80.0` | `Check latest` | ⚠️ **Check latest** (v4 upgrade; run Cloud Shell plan/apply) | `terraform/main.tf`, `terraform/bootstrap/main.tf` | [Azure Provider Releases](https://github.com/hashicorp/terraform-provider-azurerm/releases) |
...
- **Azure Provider** `~> 4.80.0` - review the v4 migration guide ([AzureRM v4 upgrade guide](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/guides/4.0-upgrade-guide)) and validate in Cloud Shell
